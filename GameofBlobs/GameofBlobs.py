...
LEARNING_RATE = 0.1
# DISCOUNT measures the relative value of possible future reward to the current reward. 
# DISCOUNT = 1 means a future reward is as important as the current one. 
# DISCOUNT = 0 means a future reward is not important at all.
DISCOUNT = 0.95
...
plt.legend()
plt.ylabel(f"Moving Average Reward {SHOW_EVERY}")
plt.xlabel("episode #")
plt.savefig('Score')
plt.show()
